...
while status:
    ...
    if choice == 1:
        ...
        for k in counsellor.keys():
                ...
                print(f"student last name :  ",counsellor[k]["last_name"])
                print(f"student contact no : ",counsellor[k]["contact no"])
                print(f"student subject : ",counsellor[k]['subject'])
                print(f"student fees : ",counsellor[k]['fees'])
 
        for k in counsellor.keys():
                print("----------------------")
                print(f"subject : {counsellor[k]['subject']}")
